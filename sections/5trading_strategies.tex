...
One can of course easily replace the cumulative mean by e.g. the mean of the past 90, 60, or 30 days. The result for the cumulative mean is shown in figure \ref{fig:mean_reversion_returns}. Again our strategy is not able to perform better than a simple buy-and-hold strategy. 
